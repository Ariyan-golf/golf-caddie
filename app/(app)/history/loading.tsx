  ...
  return (
    <div className="max-w-lg mx-auto p-4 space-y-6 pb-8">
      <div className="pt-4 space-y-2">
        ...
        <div className="h-7 w-32 rounded bg-green-50 animate-pulse" />
      </div>

      <div className="card space-y-3">
        <div className="h-5 w-40 rounded bg-green-50 animate-pulse" />
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="flex justify-between items-center py-1.5">
            <div className="h-4 w-16 rounded bg-green-50 animate-pulse" />
            <div className="h-4 w-20 rounded bg-green-100 animate-pulse" />
          </div>
        ))}
      </div>
